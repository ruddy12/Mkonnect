...
<?php
	...
	if ($numrows == 1){
		while($row = mysqli_fetch_array($result)){
			...
			$mail->Host = "info.mkonnect.co.ke";
			$mail->Port = 587;
			$mail->SMTPAuth = true;
			$mail->Username = "info@mkonnect.co.ke";
			$mail->Password = "Mkonnect!@#";
			$mail->setFrom('info@uxt.co.ke', 'Mkonnect');
			$mail->addReplyTo('info@uxt.co.ke', 'Mkonnect');
			...
			<p><a href="http:mkonnect.co.ke/reset.php</a>
